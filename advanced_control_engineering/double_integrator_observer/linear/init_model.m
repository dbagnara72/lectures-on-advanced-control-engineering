...
model = 'linear_double_integrator_observer';
...
p2placed = exp(p2place*ts_afe);
Kd = (acker(Asod',Cso',p2placed))';
kv = Kd(2)/ts_afe %[output:65c846d0]
kx = Kd(1)/ts_afe %[output:755f042c]
...
%---
%[output:65c846d0]
%   data: {"dataType":"textualVariable","outputData":{"name":"kv","value":"     6.207529798699798e+06"}}
%---
%[output:755f042c]
%   data: {"dataType":"textualVariable","outputData":{"name":"kx","value":"     5.778695313601012e+03"}}
%---
%[output:72559c6d]
